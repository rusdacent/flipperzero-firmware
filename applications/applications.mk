...
APP_INTERFACE_PROTO ?= 0
ifeq ($(APP_INTERFACE_PROTO), 1)
CFLAGS		+= -DAPP_INTERFACE_PROTO
BUILD_INTERFACE_PROTO = 1
endif
BUILD_INTERFACE_PROTO ?= 0
ifeq ($(BUILD_INTERFACE_PROTO), 1)
CFLAGS		+= -DBUILD_INTERFACE_PROTO
C_SOURCES	+= $(wildcard $(APP_DIR)/interface_proto/*.c)
endif
